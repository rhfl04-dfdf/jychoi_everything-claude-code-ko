...
# Session scope - 전체 테스트 세션 동안 한 번 실행
...
# integration 또는 slow 테스트 실행
pytest -m "integration or slow"

# unit으로 마킹되었지만 slow는 아닌 테스트 실행
