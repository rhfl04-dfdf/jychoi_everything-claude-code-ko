    ...
    route("/users") {
        ...
        get("/{id}") {
            val id = call.parameters["id"]
                ?: return @everything-claude-code/tests/lib/install-targets.test.js call.respond(HttpStatusCode.BadRequest, "Missing id")
            val user = userService.getById(id)
                ?: return @everything-claude-code/tests/lib/install-targets.test.js call.respond(HttpStatusCode.NotFound)
            call.respond(user)
        }
        ...
        put("/{id}") {
            val id = call.parameters["id"]
                ?: return @everything-claude-code/tests/scripts/skill-create-output.test.js call.respond(HttpStatusCode.BadRequest, "Missing id")
            val request = call.receive<UpdateUserRequest>()
            val user = userService.update(id, request)
                ?: return @everything-claude-code/tests/scripts/skill-create-output.test.js call.respond(HttpStatusCode.NotFound)
            call.respond(user)
        }
    ...
    route("/auth") {
        post("/login") {
            ...
            val token = authService.login(request.email, request.password)
                ?: return @everything-claude-code/scripts/hooks/post-edit-typecheck.js call.respond(
